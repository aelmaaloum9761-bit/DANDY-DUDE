  ...
  useEffect(() => {
    const fetchFeaturedProducts = async () => {
      try {
        ...
        const mockProducts = [
          { id: 'fw1', name: 'Luxury Chronograph Watch', price: 299, image: '/images/men1.jpeg', isNew: true, category: 'mens-watches' },
          { id: 'fw2', name: "Women's Elegant Watch", price: 269, image: '/images/women1.png', isNew: true, category: 'womens-watches' },
          { id: 'fw3', name: 'Premium Leather Wallet', price: 149, image: '/images/wal1.png', category: 'wallets' },
          { id: 'fw4', name: 'Designer Sunglasses', price: 199, originalPrice: 249, discount: 20, image: '/images/gmen1.jpeg', category: 'glasses' },
          { id: 'fw5', name: 'Classic Men\'s Watch', price: 249, image: '/images/men2.jpeg', category: 'mens-watches' },
          { id: 'fw6', name: 'Sport Chronograph', price: 279, image: '/images/men3.jpeg', category: 'mens-watches' },
        ];
